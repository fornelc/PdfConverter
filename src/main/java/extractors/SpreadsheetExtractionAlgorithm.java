...
public class SpreadsheetExtractionAlgorithm implements ExtractionAlgorithm {
    ...
    private static final Comparator<Point2D> POINT_COMPARATOR = new Comparator<Point2D>() {
        ...
        public int compare(Point2D arg0, Point2D arg1) {
            int rv = 0;
            float arg0X = Functions.round(arg0.getX(), 2);
            float arg0Y = Functions.round(arg0.getY(), 2);
            float arg1X = Functions.round(arg1.getX(), 2);
            float arg1Y = Functions.round(arg1.getY(), 2);
    ...
    public List<Table> extract(Page page, List<Ruling> rulings) {
        ...
        Functions.sort(spreadsheets, Rectangle.ILL_DEFINED_ORDER);
        return spreadsheets;
    }
    ...
    public boolean isTabular(Page page) {
        ...
        Page minimalRegion = page.getArea(Functions.bounds(page.getText()));
    ...
    public static List<Rectangle> findSpreadsheetsFromCells(List<? extends Rectangle> cells) {
        ...
        Functions.sort(cells, Rectangle.ILL_DEFINED_ORDER);
        ...
        while (i < pointSet.size()) {
            ...
            while (i < pointSet.size() && Functions.feq(pointsSortY.get(i).getY(), currY)) {
        ...
        while (i < pointSet.size()) {
            ...
            while (i < pointSet.size() && Functions.feq(pointsSortX.get(i).getX(), currX)) {
