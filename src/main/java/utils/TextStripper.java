...
public class TextStripper extends PDFTextStripper {
    ...
    protected void writeString(String string, List<TextPosition> textPositions) throws IOException
    {
        for (TextPosition textPosition: textPositions)
        {
            ...
            TextElement te = new TextElement(Functions.round(textPosition.getYDirAdj() - h, 2),
                    Functions.round(textPosition.getXDirAdj(), 2), Functions.round(textPosition.getWidthDirAdj(), 2),
                    Functions.round(textPosition.getHeightDir(), 2), textPosition.getFont(), textPosition.getFontSize(), c,
