...
class ObjectExtractorStreamEngine extends PDFGraphicsStreamEngine {
    ...
    private void strokeOrFillPath(boolean isFill) {
        ...
        // last move
        Point2D.Float start_pos = new Point2D.Float(Functions.round(first[0], 2), Functions.round(first[1], 2));
    ...
    class PointComparator implements Comparator<Point2D> {
        ...
        public int compare(Point2D o1, Point2D o2) {
            float o1X = Functions.round(o1.getX(), 2);
            float o1Y = Functions.round(o1.getY(), 2);
            float o2X = Functions.round(o2.getX(), 2);
            float o2Y = Functions.round(o2.getY(), 2);
